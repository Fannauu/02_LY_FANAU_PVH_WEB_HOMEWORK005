   ...
   <>
     <div className="relative space-y-4 mx-auto mt-20 justify-center gap-10 w-[80%]">
       ...
       <nav className="flex items-center py-4 mb-6">
         ...
         <svg
           xmlns="http://www.w3.org/2000/svg"
           className="h-4 w-4 mx-3 text-gray-400"
           fill="none"
           viewBox="0 0 24 24"
           stroke="currentColor">
           <path
       ...
       <div className=" mx-auto py-20 rounder-3xl  rounded-3xl">
         <div className="py-10  ">
           <div className="bg-gray-200 w-full mx-auto flex justify-between px-10">
